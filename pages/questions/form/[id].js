...
function QuestionCreate() {
  ...
  const onFinish = (values) => {
    ...
    if (activeQuestion.correctAnswer?.length !== 24) {
  ...
  return (
    <Styled className="w-[83%]" colors={colors}>
      <Head>
        ...
        <Row>
          <Col span={19}>
            ...
            <div style={{ paddingBottom: 40 }}>
              <Info title="Açıklama" titleWidthPercent={50} largePadding={true}>
                {renderVideo()}
                <Form.Item
                  label="Video"
                  name="videoUrl"
...
const Styled = styled.div`
  ...
  .submit-button {
    ...
    padding: 1.2vw 2vw;
    font-size: 1vw;
    border-color: ${({ colors }) => colors.darkPrimary};
